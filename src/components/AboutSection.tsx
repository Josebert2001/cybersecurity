      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            About Our <span className="text-cyber-yellow">Department</span>
          </h2>
          ...
          {stats.map((stat, index) => (
            <Card key={index} className="bg-card/50 border-border hover-glow transition-all duration-300">
              <CardContent className="p-6 text-center">
                <stat.icon className="h-12 w-12 text-cyber-yellow mx-auto mb-4" />
                <div className="text-3xl font-bold text-cyber-yellow mb-2">{stat.number}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <Shield className="h-6 w-6 text-cyber-yellow mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <Target className="h-6 w-6 text-cyber-yellow mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <Award className="h-6 w-6 text-cyber-yellow mt-1 flex-shrink-0" />
                <div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-cyber-yellow/20 to-cyber-blue/20 rounded-lg p-8 backdrop-blur-sm border border-cyber-yellow/30">
              <div className="font-mono text-terminal-text text-sm space-y-2">
                ...
                <div className="text-cyber-yellow">Department initialized successfully!</div>
              </div>
            </div>
          </div>
        </div>
